    ...
    <ul className="navbar-nav">
      ...
      <li className="nav-item">
        <a href="#" className="nav-link">
         ...
         ></svg>*/}
              ...
              <img src="https://img.icons8.com/nolan/64/product.png" className='rounded d-block mt-3 margenNav' alt='igsh'/>
          ...
          <span className="link-text">REGISTRAR PRODUCTO</span>
        </a>
      </li>
      ...
      <li className="nav-item">
        <a href="#" className="nav-link">
          ...
          ></svg>*/}
           ...
           <img src="https://img.icons8.com/nolan/64/discount.png" className='rounded d-block mt-3 margenNav' alt='igsh'/>
            <g className="fa-group">
              <path
                fill="currentColor"
          ...
          <span className="link-text">REGISTRAR PROMOCION</span>
        </a>
      </li>
      ...
      <li className="nav-item">
        <a href="#" className="nav-link">
          ...
          <span className="link-text">LISTA DE PROMOCIONES</span>
        </a>
      </li>
      ...
      <li className="nav-item">
        <a href="#" className="nav-link">
          ...
          <span className="link-text">SCAN QR</span>
        </a>
      </li>
